        ...
        {mostrarPerfi ?
          <>
            <S.AreaFotoPerfil>
              ...
              <S.Foto src={firebase.auth().currentUser.photoURL} className="m-2 "></S.Foto>
            </S.AreaFotoPerfil>
            <S.AreaPerfil>
              <form onSubmit={() => dataUpdate}>
                ...
                <S.GrupoInput className="p-2">
                  ...
                  <input className="input" id="name" name="name" minLength='4' maxlength='20'></input>
                </S.GrupoInput>
                ...
                <S.GrupoInput className="p-2">
                  ...
                  <input className="input" id="phone" name="phone" minLength='11' maxlength='11' ></input>
                </S.GrupoInput>

                <S.GrupoInput className="p-2">
                  <S.SpanInput size="14" className="m-2">E-mail</S.SpanInput>
                  <input className="input" type="email" name="email" id="email" value={email} onChange={(e) => setEmail(e)}></input>
                </S.GrupoInput>

                <S.GrupoInput className="p-2">
                  <S.SpanInput size="14" className="m-2"> Senha</S.SpanInput>
                  <S.Input type="password" value="123" className="input"></S.Input>
